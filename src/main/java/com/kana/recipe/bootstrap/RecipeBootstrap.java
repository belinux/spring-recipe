package com.kana.recipe.bootstrap;

import com.kana.recipe.domain.*;
import com.kana.recipe.repositories.CategoryRepository;
import com.kana.recipe.repositories.RecipeRepository;
import com.kana.recipe.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setDirections("1 Cut avocado, remove flesh: Cut the avocados in half. Remove seed. " +
                ...
                "black pepper, and chiles. Chili peppers vary individually in their hotness. So, start with a " +
                "half of one chili pepper and add to the guacamole to your desired degree of hotness.\nRemember " +
                "that much of this is done to taste because of the variability in the fresh ingredients. Start " +
                "with this recipe and adjust to your taste.\n4 Cover with plastic and chill to store: Place plastic " +
                "wrap on the surface of the guacamole cover it and to prevent air reaching it. (The oxygen in the " +
                "air causes oxidation which will turn the guacamole brown.) Refrigerate until ready to serve.\n" +
        ...
        guacNotes.setRecipeNotes("For a very quick guacamole just take a 1/4 cup of salsa and mix it in with your" +
                ...
                "and chunks of peaches in it (a Diana Kennedy favorite). Try guacamole with added pineapple, mango," +
                " or strawberries.\nThe simplest version of guacamole is just mashed avocados with salt. Don't " +
                "let the lack of availability of other ingredients stop you from making guacamole.\nTo extend " +
                "a limited supply of avocados, add either sour cream or cottage cheese to your guacamole dip." +
        ...
        tacoNotes.setRecipeNotes("We have a family motto and it is this: Everything goes better in a tortilla.\n" +
                ...
                " and sweet orange juice while the grill is heating. You can also use this time to prepare the " +
                "taco toppings.\n" +
